<!--
 * @Author: yutaiqi
 * @Date: 2024-01-23 22:35:34
 * @LastEditTime: 2024-01-24 23:17:58
 * @LastEditors: yutaiqi
 * @Description: 预约通知
 * @FilePath: /sytstudy/src/pages/hospital/notify/index.vue
-->
<template>
    <div class="notice">
        <h1 class="hosname">
            {{ hospitalDetail.hospitalInfo.hospital?.hosname }}预约挂号须知
        </h1>
